      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full lg:w-1/3 px-4">
          <div class="bg-white rounded-xl relative overflow-hidden px-7 sm:px-10 p-10 shadow-testimonial mb-10">
            <div class="mb-5">
              <img loading="lazy" src="@/assets/images/testimonial/causeforce.webp" alt="lineicons" class="h-12"
                width="60" height="60" />
            </div>
            <p class="font-medium text-lg text-body-color mb-8">
              “Christina is one of those rare copywriters who just gets it.
              She’s easy to brief, asks smart questions, and knows how to write
              omnichannel campaign copy that drives results. You feel lucky to
              get to work with her.”
            </p>
            <div class="flex items-center">
              <div class="max-w-[60px] w-full h-[60px] rounded-full overflow-hidden mr-3">
                <img loading="lazy" src="@/assets/images/testimonial/joni.webp" alt="image" class="w-full" height="60"
                  width="60" />
              </div>
              <div>
        ...
        <div class="w-full lg:w-1/3 px-4">
          <div class="bg-white rounded-xl relative overflow-hidden px-7 sm:px-10 p-10 shadow-testimonial mb-10">
            <div class="mb-5">
              <img loading="lazy" src="@/assets/images/testimonial/intrepid.webp" alt="tailgrids" height="60"
                width="120" />
            </div>
            <p class="font-medium text-lg text-body-color mb-8">
              “If you want something done efficiently and done effectively, rest
              assured that Christina Campo will do it. I’ve had the pleasure of
              working with her in various capacities and have always been
              impressed by her ability – in any given situation – to immediately
              take the initiative and deliver the perfect copy before deadline.
              A self-starter, a team-player and a ray of sunshine, I couldn’t
              recommend her more highly.”
            </p>
            <div class="flex items-center">
              <div class="max-w-[60px] w-full h-[60px] rounded-full overflow-hidden mr-3">
                <img loading="lazy" src="@/assets/images/testimonial/bex.webp" alt="image" height="60" width="60" />
              </div>
              <div>
                <h3 class="font-semibold text-base text-black mb-1">
                  Bex Shapiro
        ...
        <div class="w-full lg:w-1/3 px-4">
          <div class="bg-white rounded-xl relative overflow-hidden px-7 sm:px-10 p-10 shadow-testimonial mb-10">
            <div class="mb-5">
              <img loading="lazy" src="@/assets/images/testimonial/gal.webp" alt="ayroui" height="60" width="90" />
            </div>
            <p class="font-medium text-lg text-body-color mb-8">
              “It was a pleasure working with Christina! She is a creative
              writer and efficient in her turnaround. Would recommend her to any
              client.”
            </p>
            <div class="flex items-center">
              <div class="max-w-[60px] w-full h-[60px] rounded-full overflow-hidden mr-3">
                <img loading="lazy" src="@/assets/images/testimonial/paige.webp" alt="image" height="60" width="60"
                  class="w-full" />
              </div>
              <div>
                <h3 class="font-semibold text-base text-black mb-1">
